Scaling [myawesometmlsolutionml-mqtt-3f10-ml_mqtt] With Kubernetes
===========================
...
Based on your TML solution [myawesometmlsolutionml-mqtt-3f10-ml_mqtt] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`myawesometmlsolutionml-mqtt-3f10-ml_mqtt.yml`
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-myawesometmlsolutionml-mqtt-3f10-ml_mqtt.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingressmyawesometmlsolutionml-mqtt-3f10-ml_mqtt.yml; this yaml is 
...
.. code-block:: YAML
   ...
   kubectl apply -f kafka.yml -f secrets.yml -f mysql-storage.yml -f mysql-db-deployment.yml -f myawesometmlsolutionml-mqtt-3f10-ml_mqtt.yml

myawesometmlsolutionml-mqtt-3f10-ml_mqtt.yml
------------------------

.. important::
   Copy and Paste this YAML file: myawesometmlsolutionml-mqtt-3f10-ml_mqtt.yml - and save it locally.
...
.. code-block:: YAML
   ...
   ################# myawesometmlsolutionml-mqtt-3f10-ml_mqtt.yml
     ...
     kind: Deployment
     metadata:
       name: myawesometmlsolutionml-mqtt-3f10-ml_mqtt
     spec:
       selector:
         matchLabels:
           app: myawesometmlsolutionml-mqtt-3f10-ml_mqtt
       ...
       template:
         ...
         spec:
           containers:
           - name: myawesometmlsolutionml-mqtt-3f10-ml_mqtt
             image: maadsdocker/myawesometmlsolutionml-mqtt-3f10-ml_mqtt-amd64:latest
             volumeMounts:
             - name: dockerpath
             ...
             - name: TSS
               value: '0'
             - name: PROJECTNAME
               value: 'myawesometmlsolutionml-mqtt-3f10'                              
             - name: SOLUTIONNAME
               value: 'myawesometmlsolutionml-mqtt-3f10-ml_mqtt'
             - name: SOLUTIONDAG
               value: 'solution_preprocessing_ml_mqtt_dag-myawesometmlsolutionml-mqtt-3f10'
             - name: GITUSERNAME
               value: 'smaurice101'
             - name: GITREPOURL
   ...
   ---
     ...
     kind: Service
     metadata:
       name: myawesometmlsolutionml-mqtt-3f10-ml_mqtt-visualization-service
       labels:
         app: myawesometmlsolutionml-mqtt-3f10-ml_mqtt-visualization-service
     spec:
       type: ClusterIP
       ports:
...
.. code-block::
   ...
   kubectl port-forward deployment/myawesometmlsolutionml-mqtt-3f10-ml_mqtt 6060:6060
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-myawesometmlsolutionml-mqtt-3f10-ml_mqtt.yml to your kubernetes cluster.  First you need to save it locally then apply it:**

nginx-ingress-myawesometmlsolutionml-mqtt-3f10-ml_mqtt.yml
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-myawesometmlsolutionml-mqtt-3f10-ml_mqtt.yml
